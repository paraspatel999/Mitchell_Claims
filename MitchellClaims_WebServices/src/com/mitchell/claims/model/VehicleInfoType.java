...
public class VehicleInfoType {
    ...
    @XmlElement(name = "ModelYear", namespace = "http://www.mitchell.com/examples/claim")
    protected int modelYear;
    @XmlElement(name = "MakeDescription", namespace = "http://www.mitchell.com/examples/claim")
    protected String makeDescription;
    @XmlElement(name = "ModelDescription", namespace = "http://www.mitchell.com/examples/claim")
    protected String modelDescription;
    @XmlElement(name = "EngineDescription", namespace = "http://www.mitchell.com/examples/claim")
    protected String engineDescription;
    @XmlElement(name = "ExteriorColor", namespace = "http://www.mitchell.com/examples/claim")
    protected String exteriorColor;
    @XmlElement(name = "Vin", namespace = "http://www.mitchell.com/examples/claim")
    protected String vin;
    @XmlElement(name = "LicPlate", namespace = "http://www.mitchell.com/examples/claim")
    protected String licPlate;
    @XmlElement(name = "LicPlateState", namespace = "http://www.mitchell.com/examples/claim")
    protected String licPlateState;
    @XmlElement(name = "LicPlateExpDate", namespace = "http://www.mitchell.com/examples/claim")
    protected Date licPlateExpDate;
    @XmlElement(name = "DamageDescription", namespace = "http://www.mitchell.com/examples/claim")
    protected String damageDescription;
    @XmlElement(name = "Mileage", namespace = "http://www.mitchell.com/examples/claim")
